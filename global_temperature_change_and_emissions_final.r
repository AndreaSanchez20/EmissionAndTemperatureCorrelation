...
emission_year_plot <- plot(global_avg_temp_and_emission$ï..Year,global_avg_temp_and_emission$Emission,
...
temp_year_plot <- plot( global_avg_temp_and_emission$ï..Year,global_avg_temp_and_emission$LandAverageTemperature,
...
"""
Results:
R-squared indicates how much variation of a dependent variable (emission) is explained by the independent variable (temperature)

Our results show that R-squared us 0.57 which means that approximately more than half of the observed variation can be 
explained by the model's input.

Sources: 
https://www.investopedia.com/terms/r/r-squared.asp#:~:text=R%2DSquared%20is%20a%20statistical,s)%20in%20a%20regression%20model.
